...
from Scrapy_Iimedia_V1_01.settings import cate as c
...
class IimediaV1Spider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for k, v in c.items():
            ...
            print(cate)
            with open(
                    r'E:\Building\Data\Spider\Scrapy_Iimedia_V1_01\Scrapy_Iimedia_V1_01\spiders\cate_list1.txt',
    ...
    def parse1(self, response):
        ...
        for info in config_info:
            ...
            i += 1
            print(cate)
            with open(r'E:\Building\Data\Spider\Scrapy_Iimedia_V1_01\Scrapy_Iimedia_V1_01\spiders\cate_list1.txt',
                      'a', encoding='utf-8') as f:
                f.write(cate + '\n')
    ...
    def parse_detail(self, response):
        ...
        try:
            ...
            cate = f'"{num}": "{name}",'
            print(cate)
            with open('E:\\Building\\Data\\Spider\\Scrapy_Iimedia_V1_01\\Scrapy_Iimedia_V1_01\\spiders\\cate_list1.txt',
                      'a', encoding='utf-8') as f:
                f.write(cate + '\n')
            ...
            print('访问数据需要登录或为报告类！！')
            with open(r'E:\Building\Data\Spider\Scrapy_Iimedia_V1_01\Scrapy_Iimedia_V1_01\fail1.txt', 'a',
                      encoding='utf-8') as f:
                f.write(str(nodeID) + '\n')
...
if __name__ == '__main__':
    ...
    cmdline.execute("scrapy crawl iimedia_V1".split())
