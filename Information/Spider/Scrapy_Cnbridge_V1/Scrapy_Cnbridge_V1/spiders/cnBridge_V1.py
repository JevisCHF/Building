...
import scrapy
import re
from Scrapy_Cnbridge_V1.items import ScrapyCnbridgeV1Item
import time
from scrapy.utils import request
from Scrapy_Cnbridge_V1.start_urls import url1
...
class CnbridgeV1Spider(scrapy.Spider):
    ...
    def start_requests(self):
        yield scrapy.Request(url='http://www.cnbridge.cn/html/news/index.html', callback=self.parse)

        for i in range(1, 2997):
