...
from Scrapy_CCbuild_V1.start_urls import urls_50
from lxml import etree


class ScrapyCcbuildV1Spider(scrapy.Spider):
    name = 'Scrapy_ccBuild_V4'
    ...
    def parse(self, response):
        ...
        for config in config_list:
            ...
            item['industry_Lcategories'] = industry_categories[:2] if len(industry_categories) == 3 else industry_categories
...
if __name__ == '__main__':
    ...
    cmdline.execute(['scrapy', 'crawl', 'Scrapy_ccBuild_V4'])
